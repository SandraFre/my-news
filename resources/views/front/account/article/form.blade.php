...
<div class="row">
    ...
    <div class="col-10">
        <div class="card">
            ...
            <form
                action="{{ route('account.article.'.(isset($item->id) ? 'update' : 'store'), isset($item->id) ? ['article' => $item->id] : []) }}"
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control @error('slug') is-invalid @enderror" type="text" name="slug"
                                id="slug" value="{{ old('slug', $item->slug ?? '') }}">
                            @error('slug')
                            <div class="alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="@error('poster') is-invalid @enderror" type="file" name="poster" id="poster"
                            value="">
                        @error('poster')
                        <div class="alert-danger">
                            {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror" name="content"
                            id="content">{{ old('content', $item->content ?? '') }}</textarea>
                        @error('content')
                        <div class="alert-danger">
                            {{ $message }}
                        </div>
